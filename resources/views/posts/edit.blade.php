            ...
            <div class="panel panel-default panel-center">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('/editpst',array($posts->id)) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" rows="6" class="form-control" name="post_body"  required> {{$posts->post_body }}</textarea> 
                        ...
                        <div class="form-group{{ $errors->has('post_image') ? ' has-error' : '' }}">
                            <label for="post_image" class="col-md-4 control-label">Feature Image</label>

                            <div class="col-md-6">
                                <input id="post_image" type="file" class="form-control" name="post_image"  required autofocus>
